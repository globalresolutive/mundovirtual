                                        ...
                                        Expanded(
                                          child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                suffix: Text(
                                                  specialDiscount[index].timeslot![index1].type == "amount" ? symbol : "%",
                                                  style: TextStyle(
                                                    color: Colors.grey,
                                                  ),
                                                ),
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                'Delivery Discount',
                                                style: TextStyle(color: isDarkMode(context) ? Color(0xFFFFFFFF) : Colors.black, fontSize: 16),
                                              ),
                                              // DropdownButton<String>(
                                              //   underline: SizedBox(),
                                              //   value: specialDiscount[index].timeslot![index1].discount_type == "dinein" ? "Dine-In Discount" : "Delivery Discount",
                                              //   onChanged: (newValue) {
                                              ...
                                              child: DropdownButton<String>(
                                                ...
                                                items: type.map((String user) {
                                                  return DropdownMenuItem<String>(
                                                    ...
                                                    child: new Text(
                                                      user,
                                                      style: new TextStyle(color: isDarkMode(context) ? Colors.white : Colors.black),
                                                    ),
                                                  );
                                                }).toList(),
                                              ),
          ...
          onPressed: () {
            if (MyAppState.currentUser!.vendorID.isEmpty) {
              final snackBar = SnackBar(
                content: const Text('Please add a store first'),
              );
...
// class DayAddModel {
//   var startDate = new TextEditingController();
//   var endDate = new TextEditingController();
//   var discount = new TextEditingController();
//
//   DayAddModel({required this.startDate, required this.endDate, required this.discount});
// }
