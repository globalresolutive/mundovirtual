...
class _ReAuthUserScreenState extends State<ReAuthUserScreen> {
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'reAuthenticateOrderToPerformAction'.tr(),
    ...
    return FutureBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || (snapshot.data != true)) {
          return Center(child: Text('appleSignInNotAvailable'.tr()));
        } else {
  ...
  passwordButtonPressed() async {
    if (_passwordController.text.isEmpty) {
      ...
      await showProgress(context, 'verifing'.tr(), false);
      try {
    ...
    await FireStoreUtils.firebaseSubmitPhoneNumber(
      ...
      (auth.FirebaseAuthException error) async {
        if (mounted) {
          ...
          String message = 'errorOccuredTryAgain'.tr();
          switch (error.code) {
            ...
            case 'user-disabled':
              ...
              break;
            default:
              message = 'errorOccuredTryAgain'.tr();
              break;
          }
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
