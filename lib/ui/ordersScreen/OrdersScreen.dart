...
import 'package:gromartstore/services/pushnotification.dart';
import 'package:gromartstore/ui/chat/ChatScreen.dart';
...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  void initState() {
    ...
    futureCurrency.then((value) {
      for (CurrencyModel currencyModel in value) {
        curcy(currencyModel);
      }
    });
    getcurcy();
          ...
          StreamBuilder<List<OrderModel>>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
                  return Center(
                    child: showEmptyState('noOrders'.tr(), 'orderRequestWillShowHere'.tr()),
                  );
                } else {
                  ...
                  child: Row(children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                      ...
                      Text(
                        ...
                        style:
                            TextStyle(fontSize: 18, color: isDarkMode(context) ? Colors.white : Color(0XFF000000), letterSpacing: 0.5, fontFamily: 'Poppinsm'),
                      ),
                      SizedBox(
                        height: 7,
                      ),
                      orderModel.takeAway!
                          ? Text(
                              'takeaway'.tr(),
                              style: TextStyle(
                                  fontSize: 15, color: isDarkMode(context) ? Colors.white : Color(0XFF555353), letterSpacing: 0.5, fontFamily: 'Poppinsl'),
                            )
                          : Row(children: [
                      ...
                      orderModel.takeAway!
                          ...
                          : Container(
                              ...
                              child: Text(
                                ...
                                maxLines: 1,
                                style: TextStyle(
                                    color: isDarkMode(context) ? Colors.white : Color(0XFF555353), fontSize: 15, letterSpacing: 0.5, fontFamily: 'Poppinsr'),
                              ),
                            ),
                    ])
                  ])),
                      ...
                      children: [
                        ListTile(
                          ...
                          title: Text(
                            product.name,
                            style: TextStyle(
                                color: isDarkMode(context) ? Colors.white : Color(0XFF333333), fontSize: 18, letterSpacing: 0.5, fontFamily: 'Poppinsr'),
                          ),
                          trailing: Text(
                            symbol.toString() +
                          ...
                          child: Row(children: [
                            ...
                            product.extras.isEmpty
                                ...
                                : Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(
                                      product.extras.toString().replaceAll("[", " ").replaceAll("]", ""),
                                      style: TextStyle(fontSize: 16, color: Colors.grey, fontFamily: 'Poppinsr'),
                                    ),
                                  )
                          ]),
              ...
              Container(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Text(
                      ...
                      // : '$symbol${total.toDouble().toStringAsFixed(2)}',
                  ...
                  : Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text(
                          'remark'.tr(),
                          style: TextStyle(
                              fontSize: 15, color: isDarkMode(context) ? Colors.white : Color(0XFF333333), letterSpacing: 0.5, fontFamily: 'Poppinsr'),
                        ),
                        InkWell(
                          onTap: () {
              ...
              Container(
                  ...
                  child: Row(
                    ...
                    children: [
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              FireStoreUtils.sendFcmMessage(
                                  "orderHasAccepted".tr().toString(), '${orderModel.vendor.title} ' + 'hasAcceptOrder'.tr(), orderModel.author!.fcmToken);

                              if (orderModel.status == ORDER_STATUS_PLACED && !orderModel.takeAway!) {
                                FireStoreUtils.sendFcmMessage("newDelivery".tr(), 'newDeliveryRequest'.tr(), orderModel.driver!.fcmToken);
                              }
                            },
                            child: Text(
                              'accept'.tr(),
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              FireStoreUtils.updateOrder(orderModel);
                              FireStoreUtils.sendFcmMessage(
                                  "orderHasRejected".tr(), '${orderModel.vendor.title} ' + 'hasRejectOrder'.tr(), orderModel.author!.fcmToken);
                              ...
                              if (orderModel.paymentMethod!.toLowerCase() != 'cod') {
                                FireStoreUtils.createPaymentId().then((value) {
                                  ...
                                  FireStoreUtils.topUpWalletAmount(
                                          paymentMethod: "Refund Amount", userId: orderModel.author!.userID, amount: total.toDouble(), id: paymentID)
                                      .then((value) {
                              ...
                              if (orderModel.status == ORDER_STATUS_REJECTED && !orderModel.takeAway!) {
                                FireStoreUtils.sendFcmMessage("rejectOrder".tr(), 'rejectOrderRequest'.tr(), orderModel.driver!.fcmToken);
                              }
                            },
                            child: Text(
                              'reject'.tr(),
                      ...
                      if (orderModel.status != ORDER_STATUS_PLACED || orderModel.status != ORDER_STATUS_REJECTED) PrintTicket(orderModel: orderModel),
                      if (orderModel.status != ORDER_STATUS_PLACED && !orderModel.takeAway!)
                        Expanded(
                          ...
                          ? Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  FireStoreUtils.sendFcmMessage(
                                      "orderHasCompleted".tr(), '${orderModel.vendor.title} ' + 'hasCompleteOrder'.tr(), orderModel.author!.fcmToken);
                                },
                                child: Container(
                                    ...
                                    decoration:
                                        BoxDecoration(borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: Color(COLOR_PRIMARY))),
                                    child: Text(
