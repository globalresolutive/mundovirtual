              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
                  return Container(
                    ...
                    child: showEmptyState('noCoupons'.tr(), 'yourCouponsWillShowHere'.tr()),
                  );
                } else {
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Text(
                                                      "offerExpireOn".tr() + getDate(snapshot.data![index].expireOfferDate!.toDate().toString())!,
                                                      style: TextStyle(
                                                        fontSize: 15,
                                                        fontFamily: "Poppins",
                                                        letterSpacing: 0.5,
                              ...
                              Align(
                                ...
                                child: Container(
                                  child: Stack(
                                    ...
                                    children: [
                                      Container(
                                          width: 75, margin: EdgeInsets.only(bottom: 10), child: Image(image: AssetImage("assets/images/offer_badge.png"))),
                                      Container(
                                        margin: EdgeInsets.only(top: 3),
                                        child: Text(
                                          "${snapshot.data![index].discountTypeOffer == "Fix Price" ? "$symbol" : ""}${snapshot.data![index].discountOffer}${snapshot.data![index].discountTypeOffer == "Percentage" ? "%off".tr() : "off".tr()}",
