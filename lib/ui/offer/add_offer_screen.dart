    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            "createOffer".tr(),
            style:
                TextStyle(fontFamily: "Poppins", letterSpacing: 0.5, fontWeight: FontWeight.normal, color: isDarkMode(context) ? Colors.white : Colors.black),
          ),
          centerTitle: false,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: validateEmptyField,
                            decoration: InputDecoration(
                                hintText: _result == "percentage".tr() ? "addPercentage".tr() : "addPrice".tr(),
                                suffixIcon: Container(
                                  margin: EdgeInsets.only(top: 11, right: 0),
                                  child: Text(
                                    _result == "percentage".tr() ? "%" : symbol,
                          ...
                          DateTimeField(
                            ...
                            validator: (date) => (txtExpieryDate.text == '') ? 'filedCannotBeEmpty'.tr() : null,
              ...
              GestureDetector(
                onTap: () async {
                  if (_formKey.currentState?.validate() == false) {
                    ...
                    await showProgress(context, widget.offerModel == null ? 'addingOffer'.tr() : "editingOffer".tr(), false);
                    if (_mediaFiles.length > 0) {
                      var uniqueID = Uuid().v4();
                      Reference upload = FirebaseStorage.instance.ref().child('flutter/gromart/offerImages/$uniqueID'
                          '.png');
                ...
                child: Container(
                  ...
                  child: Text(
                    widget.offerModel == null ? "createCoupon".tr() : "editCoupon".tr(),
