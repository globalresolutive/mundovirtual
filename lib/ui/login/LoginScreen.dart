...
import 'package:gromartstore/ui/phoneAuth/PhoneNumberInputScreen.dart';
import 'package:gromartstore/ui/resetPasswordScreen/ResetPasswordScreen.dart';
...
class _LoginScreen extends State<LoginScreen> {
  ...
  _loginWithEmailAndPassword(String email, String password) async {
    ...
    await hideProgress();
    print('\x1b[93m Vendor ID : ${result.vendorID}');
    if (result != null && result is User && result.role == 'vendor') {
      ...
      showAlertDialog(context, 'notAuthenticate'.tr(), 'loginFailedTryAgain'.tr(), true);
  ...
  loginWithFacebook() async {
    try {
      ...
      showAlertDialog(context, 'error'.tr(), 'notLoginWithFacebook'.tr(), true);
    }
  }
  ...
  loginWithApple() async {
    try {
      ...
      if (result != null && result is User) {
        ...
        showAlertDialog(context, 'error'.tr(), 'notLoginWithApple'.tr(), true);
      }
    } catch (e, s) {
      await hideProgress();
